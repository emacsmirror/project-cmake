#+title: project-cmake.el - A cmake backend for project.el
#+author: Lucius Martius
#+language: en

#+html: <a href="https://melpa.org/#/project-cmake"><img src="https://melpa.org/packages/project-cmake-badge.svg"></a>
#+html: <a href="https://stable.melpa.org/#/project-cmake"><img src="https://stable.melpa.org/packages/project-cmake-badge.svg"></a>
#+html: <a href="https://github.com/lucius-martius/project-cmake/actions/workflows/test.yml"><img src="https://img.shields.io/github/actions/workflow/status/lucius-martius/project-cmake/test.yml?label=CI"></a>
...
On any fresh or initial run, if your project has presets defined in a [[https://cmake.org/cmake/help/latest/manual/cmake-presets.7.html][CMakePresets.json]] file, =project-cmake-run-cmake= will prompt you for a selection.
